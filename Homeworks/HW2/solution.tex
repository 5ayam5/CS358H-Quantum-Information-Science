...
\section{Single Qubit Quantum Circuits}
...
\section{Distinguishability of states}
Say you are given a state $\ket{\psi}$ that is either $\ket{0}$ or $\ket{1}$ but you don't know which. You can distinguish the two via a measurement in the $\{\ket{0}, \ket{1}\}$-basis.
\input{4}
