...
\newtcolorbox[auto counter,number within=section]{solution}[1][]{every float=\centering,breakable,enhanced,adjusted title={Question \thetcbcounter},#1,colback=codegray,colframe=codegray!50!black}
...
\section{Local Evolution of Entangled States}
\input{1}
...
\begin{minipage}[t]{\textwidth}
  ...
  \begin{quantikz}
    ...
    \lstick{$\ket{\psi_{\text{in}}}$} & \qw & \gate{X} & \ctrl{-1} & \gate{P} & \qw & \rstick{$\ket{\psi_{\text{out}}}$}
  \end{quantikz}
\end{minipage}
...
\section{Another Quantum Money Attack}
\input{5}
